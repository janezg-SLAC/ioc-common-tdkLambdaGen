#!$$IOCTOP/bin/$$IF(ARCH,$$ARCH,linux-x86_64)/geneSys
...
# Note: the default port speed on device is set to 9600
$$LOOP(GENESYS)
dbLoadRecords("db/geneSys.db","DEV=$$BASE,PORT=GENESYS$$INDEX,ADR=6,COMSPD=9600,COMDEV=$$PORT,DSCAN=$$IF(DATASCAN,$$DATASCAN,1),CSCAN=$$IF(CONFSCAN,$$CONFSCAN,10)")
$$ENDLOOP(GENESYS)
